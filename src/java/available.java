...
String sql = "select * from books where firstname=? and password=?";
...
+ "<td>" + r.getString("id") + "</td><td>" + r.getString("Bookname") + "</td><td>" + r.getString("Price") +"</td>"+"</tr></body></html>");
...
"					<li class=\"nav-item \"><span><a class=\"nav-link active\" href=\"available.java\">Books Available</a></span></li>\n" +
"					<li class=\"nav-item \"><span><a class=\"nav-link active\" href=\"YourOrder.java\">User Order</a></span></li>\n" +
"				</ul>\n" +
"				</div>\n" +
"			</nav>"
            ...
            + ""
            + "<br>"
            + "<div id=\"topmid\"><h1>Availabel Books</h1></div>"
            + "<br>"
          
            +"<h3><a href="+"add.html"+">Click Here To Add Books</a></h3>"
            + "<table class=\"tab\">"
            + "<tr>"
